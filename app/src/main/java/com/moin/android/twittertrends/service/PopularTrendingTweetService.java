...
import com.moin.android.twittertrends.BuildConfig;
import com.moin.android.twittertrends.ExtendedTwitterApiClient;
import com.moin.android.twittertrends.Logger;
import com.moin.android.twittertrends.model.Trend;
import com.moin.android.twittertrends.model.TrendsResult;
import com.moin.android.twittertrends.storage.StorageHelper;
...
public class PopularTrendingTweetService extends IntentService {
        ...
        try {
            ...
            */
            ...
            if (BuildConfig.DEBUG) {
                Logger.d(LOG_TAG, "*** Faking Bangalore, India location");
                woeid = getLocationWOEID(12.972442, 77.580643);
            } else
    ...
    private long getLocationWOEID(double latitude, double longitude) throws TweetServiceException {
        ...
        List<com.moin.android.twittertrends.model.Location> locations = trendsClient.getTrendsService().closest((long) latitude, (long) longitude);
        if (locations != null && !locations.isEmpty()) {
            com.moin.android.twittertrends.model.Location loc = locations.get(0);
